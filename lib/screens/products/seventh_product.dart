...
class SeventhProduct extends StatefulWidget {
  const SeventhProduct({super.key});

  @override
  State<SeventhProduct> createState() => _SeventhProductState();
}

class _SeventhProductState extends State<SeventhProduct> {
  @override
        ...
        child: Stack(
          children: [
            ...
            Positioned(
                top: 90,
                left: 10,
                child: Image.asset('assets/text11.png',
                    width: MediaQuery.of(context).size.width * 0.6)),
            Positioned(
                top: 180,
                left: 10,
                child: Image.asset('assets/text12.png',
